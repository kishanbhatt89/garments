...
let KTDatatablesServerSide = function () {
    ...
    let initDatatable = function () {
        ...
        dt = $("#kt_datatable_module").DataTable({
            ...
            ajax: {
                url: APP_URL+"/admin/designations/table",
            },
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            ...
                            <a href="#" onclick="edit(${data.id})" data-state="${data.id}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-kt-docs-table-filter="edit_row">
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                const designation = parent.querySelectorAll('td')[1].innerText;
                ...
                Swal.fire({
                    ...
                    if (result.value) {                                        
                        ...
                        $.ajax({
                            ...
                            url: APP_URL+'/admin/designations/' + designation,
                        ...
                        toastr.error(designation + " state was not deleted.");
        ...
        if (deleteSelected) {
            ...
            deleteSelected.addEventListener('click', function () {
                ...
                Swal.fire({
                    ...
                    text: "Are you sure you want to delete selected designations?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: APP_URL+'/admin/designations/destroyMultiple',
                    
                            data: { designations: designationsArr },
                        ...
                        Swal.fire({
                            ...
                            text: "Selected designations was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
