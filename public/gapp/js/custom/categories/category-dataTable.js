...
let KTDatatablesServerSide = function () {
    ...
    let initDatatable = function () {
        ...
        dt = $("#kt_datatable_module").DataTable({
            ...
            ajax: {
                url: APP_URL+"/admin/categories/table",
            },
                ...
                Swal.fire({
                    ...
                    if (result.value) {                                        
                        ...
                        $.ajax({
                            ...
                            url: APP_URL+'/admin/categories/' + category,
                        ...
                        toastr.error(category + " was not deleted.");
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: APP_URL+'/admin/categories/destroyMultiple',
