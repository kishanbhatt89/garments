    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                const type = parent.querySelectorAll('td')[1].innerText;
                ...
                Swal.fire({
                    ...
                    if (result.value) {                                        
                        ...
                        toastr.error(type + " was not deleted.");
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: APP_URL+'/admin/types/destroyMultiple',
                        ...
                        Swal.fire({
                            ...
                            text: "Selected types was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
