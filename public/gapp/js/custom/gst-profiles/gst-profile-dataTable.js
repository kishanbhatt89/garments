                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            ...
                            <a href="#" onclick="edit(${data.id})" data-gst-profile="${data.id}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-kt-docs-table-filter="edit_row">
