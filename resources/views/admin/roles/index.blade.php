...
@section('content')
    ...
    @include('admin.roles.partials._toolbar')
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <div class="d-flex flex-stack mb-5">
                        ...
                        @include('admin.roles.partials._filter')
    ...
    @include('admin.roles.partials._add')
...
@section('custom-js')
    <script src="{{ asset('gapp') }}/js/custom/roles/role-dataTable.js"></script>
    <script src="{{ asset('gapp') }}/js/custom/roles/role-functions.js"></script>
    <script src="{{ asset('gapp') }}/js/custom/roles/role-utils.js"></script>
@endsection