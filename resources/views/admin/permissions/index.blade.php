...
@section('content')
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack justify-content-center">
            ...
            <!-- <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <div class="m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6220eda10b2c0">
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6220eda10b2c0" data-allow-clear="true">
                                        <option></option>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="modal fade" id="kt_modal_add_permission" data-bs-dismiss="modal" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
