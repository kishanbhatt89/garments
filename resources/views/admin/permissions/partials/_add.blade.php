                    ...
                    <div class="alert alert-danger">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <h4 class="mb-4 text-dark">
                                <i class="far fa-lightbulb fs-4 text-danger me-2"></i>Permission Patter: {moduel}_management-{permission}
                            </h4>
                            <!--end::Title-->
                            <!--begin::Content-->                                                        
                            ...
                            <div>
                                <h5>Permission:</h5>
                                <span class="badge badge-light-dark">create</span>
                                <span class="badge badge-light-dark">read</span>
                                <span class="badge badge-light-dark">update</span>
                                <span class="badge badge-light-dark">delete</span>  
                            </div>                          
                            <!--end::Content-->
                        </div>
                        <!--end::Wrapper-->
