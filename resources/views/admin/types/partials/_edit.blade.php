<div class="modal-dialog modal-dialog-centered mw-750px">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h2 class="fw-bolder">Edit a Type</h2>
        ...
        <input type="hidden" id="existing_type" value="{{ $type->name }}">
        ...
        <div class="modal-body scroll-y mx-lg-5 my-7">
            ...
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_edit" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit" data-kt-scroll-wrappers="#kt_modal_edit" data-kt-scroll-offset="300px">
                ...
                <div class="fv-row mb-10">
                    ...
                    <input class="form-control form-control-solid" placeholder="Enter a type" name="name" id="type_name" value="{{ $type->name }}" />
                    
                    <span class="invalid-feedback d-none type-name-error" role="alert">
                        <strong></strong>
                    </span>
...
<script>    
    ...
    $('#updateBtn').on('click', function(e) {
        ...
        let existing_type = $("#existing_type").val();

        update(name, id, existing_type)
